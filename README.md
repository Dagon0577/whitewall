...
- [Day 1-搭建环境](#Day 1)
- [Day 2-基本框架开发/IOC和AOP/数据库配置和首页的创建/用户注册登录以及使用token](#Day 2)
- [Day 3-新增发表问题功能，并防止xss注入以及敏感词过滤](#Day 3)
- [Day 4-新增评论和站内信功能](#Day 4)
- [Day 5-新增点赞和点踩功能，使用Redis实现](#Day 5)
- [Day 6-新增异步消息功能 新增邮件发送组件](#Day 6)
- [Day 7-新增关注功能，开发关注页面和粉丝页面](#Day 7)
---
## Day 1
